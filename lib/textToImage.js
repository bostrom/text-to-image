...
const createTextData = (
  ...
  var textX = 0;
  if ( textAlign.toLowerCase() == "center" ) textX = maxWidth / 2;
  if ( textAlign.toLowerCase() == "start" || textAlign.toLowerCase() == "left" ) textX = 0;
  if ( textAlign.toLowerCase() == "end" || textAlign.toLowerCase() == "right" ) textX = maxWidth;
